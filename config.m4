...
if test $PHP_ARANGODB != "no"; then
    ...
    PHP_NEW_EXTENSION(arangodb, php_arangodb.cpp src/request.cpp src/connection.cpp src/response.cpp src/cursor.cpp src/cursor_iterator.cpp src/array_to_vpack.cpp, $ext_shared)
fi
